...
Crear solo el checkpoint commit `feat: add CU-06 relational mapping core` sin incluir `frontend/next-env.d.ts`, y detenerse. No iniciar Incremento 2 ni CU-07.
